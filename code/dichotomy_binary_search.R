...
# 1. Initialize the lowest (low) index, the highest index (high)
# 2. Find the search_value of the middle index mid=(low+high)/2 scores[mid]
# 3. Compare the scores[mid] with search_value
# If the scores[mid]==search_value print current mid index,
# If scores[mid]>search_value that the search_value will be found between
# low and mid-1
# 4. And so on. Repeat step 3 until you find search_value or low>=high to
# terminate the loop.
